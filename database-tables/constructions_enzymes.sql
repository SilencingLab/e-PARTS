...
CREATE TABLE `enzymes` (
  ...
  `restriction_sites` varchar(20) NOT NULL,
  `cut_pos_1` int(11) NOT NULL,
  `cut_pos_2` int(11) NOT NULL,
  PRIMARY KEY (`code`)
...
INSERT INTO `enzymes` VALUES ('1','bpii','gaagac',2,6),('2','bsai','ggtctc',1,5),('3','esp3i','cgtctc',1,5);
...
-- Dump completed on 2017-03-24 12:24:17
